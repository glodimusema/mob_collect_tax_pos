...
class _SelectGenreState extends State<SelectGenre> {
  ...
  final _baseUrl = '${PubCon.cheminApi}fetch_data_genre2/';
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            setState(() {
                              PubCon.id_genre = _posts[index]['id'];
                              PubCon.code_genre = _posts[index]['code_genre'];
                            });

                            if (Navigator.canPop(context)) {
                              Navigator.pop(context, PubCon.code_genre);
                            } else {
                              SystemNavigator.pop();
                            }
                          },
                          child: ListTile(
                            title: Text(_posts[index]['code_genre']),
                            subtitle: Text("${_posts[index]['code_genre']}"),
                            trailing: IconButton(
